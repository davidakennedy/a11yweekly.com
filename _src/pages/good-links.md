...
- **isn't a link to a product page**. Linking to a product page, much like apps, implies an endorsement. I don't have the time to test products fully, nor am I often the primary audience most of the time. Instead, write a blog post or create a video/talk about the why behind the app and/or how it took an inclusive approach to its design.
